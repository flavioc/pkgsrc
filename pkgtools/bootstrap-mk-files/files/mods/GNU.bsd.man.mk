#	$NetBSD: GNU.bsd.man.mk,v 1.10 2024/08/09 22:12:45 wiz Exp $
...
.if exists(${DESTDIR}/usr/share/groff/1.23/tmac)
TMACDIR?=	${DESTDIR}/usr/share/groff/1.23/tmac
.elif exists(${DESTDIR}/usr/share/groff/1.21/tmac)
