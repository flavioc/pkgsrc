# $NetBSD: tools.GNU.mk,v 1.71 2024/08/06 03:50:23 tnn Exp $
#
# System-supplied tools for the GNU operating system.

_GNU_BINPATHS?=	/bin /usr/bin /sbin /usr/sbin

.for _path in ${_GNU_BINPATHS}
